...
#VALIDATION
    name = Capitalize(
        ...
        widget=forms.TextInput(attrs={
                                        ...
                                        'style': 'margin-top: auto, margin-bottom: auto,padding:0, border: 10px solid #0f0f0f, font-weight: bold',
                                        }
                                )
    )
    email = Lowercase(
        ...
        widget=forms.TextInput(attrs={
                                        ...
                                        'style': 'margin-top: auto, margin-bottom: auto,padding:0, font-weight: bold',
                                    }
                                ),
    )
    ...
    message = forms.CharField(
        ...
        widget=forms.Textarea(attrs={
                                        ...
                                        'style': 'margin-top: auto, margin-bottom: auto,padding:0, border: 1px solid #000, font-weight: bolder',
                                        'rows':4
                                    }
                            )
    )
