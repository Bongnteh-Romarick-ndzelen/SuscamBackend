...
class Courses(models.Model):
    ...
    course_img = models.ImageField(upload_to='CourseImage/', validators=[FileExtensionValidator(
        allowed_extensions=['jpg', 'png', 'jpeg'])], null=True, blank=True)
...
class Profile(models.Model):
    ...
    profile_img = models.ImageField(upload_to="profile_Images", default="default.jpg",  validators=[
                                    FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg'])])
    ...
    courses_enroll = models.ManyToManyField(
        Courses, related_name='Enrolled_courses', blank=True)
...
class Team(models.Model):
    ...
    member_img = models.ImageField(upload_to="TeamImages", validators=[
                                   FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg'])])
